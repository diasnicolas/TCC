...
\section{Ferramentas de manipulação}

Pode-se dizer que a manipulação de bytecode é uma tarefa complexa, pois bytecode é uma linguagem de baixo nível, e o aprendizado desta linguagem para programadores de alto nível, tende a ser muito lenta, fazendo com que seja invável o seu aprendizado dentro do escopo de um projeto.
