...
\section{Objetivo}
Este trabalho tem como objetivo geral desenvolver um \textit{framework} que aplique os conceitos de Programação Orientada à Aspectos.

Os objetivos específicos deste trabalho são: 

\begin{itemize}
\item Entender os principais conceitos de AOP.
\item Aplicar os conceitos de AOP no desenvolvimento de um \textit{framework}.
