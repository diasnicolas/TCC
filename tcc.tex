...
A figura \ref{fig:fluxogramaAgent} mostra todos os processos realizados pela JVM quando é chamado um Agent junto à chama de um sistema. O fluxograma foi desenvolvido utilizando ferramentas disponibilizadas em \textit{http://cacoo.com}.
