...
Este recurso da linguagem java será utilizado neste trabalho para interceptação das classes, com a finalidade de combinar os interesses centrais com os interesses transverssais de um sistema, ou seja, será em cima do Agente Java que será desenvolvido o combinador de aspectos (\textit{weaver aspects}).
